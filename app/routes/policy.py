...
from app.arlmodules import ErrorMsg
...
domain_config_fields = ns.model('domainConfig', {
    ...
    "domain_oneforall": fields.Boolean(description="oneforall调用", default=True),
    "dns_query_plugin": fields.Boolean(description="域名插件查询", default=True)
})

'''IP 相关配置选项'''
ip_config_fields = ns.model('ipConfig', {
    "port_scan": fields.Boolean(description="端口扫描", default=True),
    "port_scan_type": fields.String(description="端口扫描类型(test|top100|top1000|all|custom)", example="all"),
...
site_config_fields = ns.model('siteConfig', {
    ...
    "unauth_scan": fields.Boolean(description="unauth 扫描", default=False),
    "nuclei_scan": fields.Boolean(description="nuclei 扫描", default=False),
    "xray_scan": fields.Boolean(description="xray 扫描", default=False),
