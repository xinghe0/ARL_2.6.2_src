...
from app.arlmodules import TaskStatus, ErrorMsg, TaskSyncStatus, CeleryAction, TaskTag, TaskType
...
base_search_task_fields = {
    ...
    'options.domain_oneforall': fields.Boolean(description="是否开启oneforall子域名调用"),
...
add_task_fields = ns.model('AddTask', {
    ...
    'src': fields.String(description="SRC平台"),
    'remark': fields.String(description="备注"),
    "domain_brute": fields.Boolean(),
    'domain_oneforall': fields.Boolean(),
    ...
    "xray_scan": fields.Boolean(description="xray 扫描", example=False, default=False),
    "web_info_hunter": fields.Boolean(description="敏感信息获取", example=False, default=False),
    "unauth_scan": fields.Boolean(description="未授权扫描", example=False, default=False),
...
class ARLTask(ARLResource):
    ...
    def get(self):
        ...
        data = self.build_data_task(args=args, collection='task')
