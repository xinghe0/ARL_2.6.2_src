            ...
            for vuln_info in vuln_infos:
                if vuln_info[3] == "unAuth" and vuln_info[4] == 1:
                    ...
                    for api_info in api_infos:
                        ...
                        api_path = api_info[1]
                        run = para2.add_run("2." + str(self.creat_num) + " " + str(UserLogin) + Utils().getMyWord(
                            "{r_vuln_unauth}") + "\n")
                        run.font.name = "Arial"
                        run.font.size = Pt(16)
                        run.font.bold = True
                    ...
                    run5 = para3.add_run(
                        "2." + str(self.creat_num) + " " + str(api_path) + Utils().getMyWord("{r_vuln_CORS}") + "\n")
                    run5.font.name = "Arial"
            ...
            for vuln_info in vuln_infos:
                if vuln_info[3] == "passWord":
                    ...
                    for api_info in api_infos:
                        ...
                        api_path = api_info[1]
                        run = para3.add_run(
                            "2." + str(k - self.creat_num1 + 1) + " " + str(UserLogin) + Utils().getMyWord(
                                "{r_vuln_passWord}") + "\n")
                        run.font.name = "Arial"
                        run.font.size = Pt(16)
                        run.font.bold = True
