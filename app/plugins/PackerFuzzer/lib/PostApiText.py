        ...
        try:
            ...
            while (code == "415" or code == "401"):
                ...
                if tag == 1:
                    ...
                    if code == "200":
                        text = str(
                            requests.post(url, headers=header, timeout=6, data=data, proxies=self.proxy_data,
                                          verify=False).text)  # 正常的返回code是int类型
                        self.res[url] = text
                        break
                ...
                if tag == 2:
                    ...
                    if code == "200":
                        if sslFlag == 1:
                            text = str(requests.post(url, headers=header, timeout=6, data=data, proxies=self.proxy_data,
