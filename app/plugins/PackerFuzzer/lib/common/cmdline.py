...
class CommandLines():
    ...
    def cmd(self):
        ...
        parse.add_option('-o', '--out', dest='out', help='Please Enter the Target Site Result File Name')
        ...
        parse.add_option('-r', '--report', dest='report', default='html,doc', type=str,
                         help='Choose your report\'s type')
        ...
        parse.add_option('--fe', '--fileext', dest='filenameextension', type=str,
                         help='Api Filename Extension such as: .json')
