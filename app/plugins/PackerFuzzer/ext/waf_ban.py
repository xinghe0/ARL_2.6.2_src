...
class ext():
    ...
    def __init__(self, projectTag, options):
        ...
        self.ban_title = ["您的访问请求可能对网站造成安全威胁", "您的请求包含恶意行为", "已被服务器拒绝拦截时间",
                          "Request blocked",
                          "The incident ID is", "非法操作！", "网站防火墙", "已被网站管理员设置拦截", "拦截提示",
                          "入侵防御系统",
                          "可能托管恶意活动", "您正在试图非法攻击", "玄武盾", "检测到可疑访问", "当前访问疑似黑客攻击",
                          "创宇盾", "安全拦截",
                          "您的访问可能对网站造成威胁", "此次访问可能会对网站造成安全威胁", "have been blocked",
                          "您的访问被阻断",
    ...
    def run(self):
        ...
        if sslFlag == 1:
            testWeb = requests.get(self.options.url, proxies=proxy_data, headers=header, timeout=7,
