...
api = Api(arl_app, prefix="/api", doc="/api/54d6c66bf3253e5f9c1d20b37771471d/doc", title='API', authorizations=authorizations,
          description='SRC资产扫描平台', security="ApiKeyAuth", version="2.6.2")
...
api.add_namespace(routes.index_ns)
api.add_namespace(routes.unauth_ns)
api.add_namespace(routes.xray_result)
api.add_namespace(routes.src_ns)
